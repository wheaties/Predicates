...
trait PartialFunction9[-T1, -T2, -T3, -T4, -T5, -T6, -T7, -T8, -T9, +R] extends ((T1, T2, T3, T4, T5, T6, T7, T8, T9) => R){
	...
	override def tupled = new PartialFunction[(T1, T2, T3, T4, T5, T6, T7, T8, T9), R]{
		def isDefinedAt(v1: (T1, T2, T3, T4, T5, T6, T7, T8, T9)) = self isDefinedAt(v1._1, v1._2, v1._3, v1._4, v1._5, v1._6, v1._7, v1._8, v1._9)
		def apply(v1: (T1, T2, T3, T4, T5, T6, T7, T8, T9)) = self(v1._1, v1._2, v1._3, v1._4, v1._5, v1._6, v1._7, v1._8, v1._9)
	}
