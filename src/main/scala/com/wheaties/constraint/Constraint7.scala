...
trait Constraint7[A,B,C,D,E,F,G]extends Predicate1[Function7[A,B,C,D,E,F,G,Boolean]]{
	def constrain[H](that: Constraint1[H]) = new Constraint8[A,B,C,D,E,F,G,H]{
		def apply(pred: Function8[A,B,C,D,E,F,G,H,Boolean]) = Constraint7.this((x0,x1,x2,x3,x4,x5,x6) => that(pred(x0,x1,x2,x3,x4,x5,x6,_)))
	}
