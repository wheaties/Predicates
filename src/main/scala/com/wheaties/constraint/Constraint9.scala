...
trait Constraint9[A,B,C,D,E,F,G,H,I]extends Predicate1[Function9[A,B,C,D,E,F,G,H,I,Boolean]]{
	def constrain[J](that: Constraint1[J]) = new Constraint10[A,B,C,D,E,F,G,H,I,J]{
		def apply(pred: Function10[A,B,C,D,E,F,G,H,I,J,Boolean]) = Constraint9.this((x0,x1,x2,x3,x4,x5,x6,x7,x8) => that(pred(x0,x1,x2,x3,x4,x5,x6,x7,x8,_)))
	}
