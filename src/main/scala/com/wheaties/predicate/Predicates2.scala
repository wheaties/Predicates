...
object Predicate2{
  implicit def conn[T1,T2,Q1 >: T1,Q2 >: T2] = new Connective[Predicate2[T1,T2],Predicate2[Q1,Q2],Predicate2[T1,T2]]{
    def or(p: Predicate2[T1,T2], q: Predicate2[Q1,Q2]) = new Predicate2[T1,T2]{
      def apply(arg0: T1, arg1: T2) = p(arg0, arg1) || q(arg0, arg1)
    }

    def and(p: Predicate2[T1,T2], q: Predicate2[Q1,Q2]) = new Predicate2[T1,T2]{
      def apply(arg0: T1, arg1: T2) = p(arg0, arg1) && q(arg0, arg1)
    }

    def xor(p: Predicate2[T1,T2], q: Predicate2[Q1,Q2]) = new Predicate2[T1,T2]{
      def apply(arg0: T1, arg1: T2) = if(p(arg0, arg1)) !q(arg0, arg1) else q(arg0, arg1)
    }

    def nxor(p: Predicate2[T1,T2], q: Predicate2[Q1,Q2]) = new Predicate2[T1,T2]{
      def apply(arg0: T1, arg1: T2) = if(p(arg0, arg1)) q(arg0, arg1) else !q(arg0, arg1)
    }

    def nand(p: Predicate2[T1,T2], q: Predicate2[Q1,Q2]) = new Predicate2[T1,T2]{
      def apply(arg0: T1, arg1: T2) = !(p(arg0, arg1) && q(arg0, arg1))
    }

    def nor(p: Predicate2[T1,T2], q: Predicate2[Q1,Q2]) = new Predicate2[T1,T2]{
      def apply(arg0: T1, arg1: T2) = !(p(arg0, arg1) || q(arg0, arg1))
    }
  }
